...
import com.example.widget.ItemsRange;
import com.example.widget.OnWheelChangedListener;
import com.example.widget.OnWheelClickedListener;
import com.example.widget.OnWheelScrollListener;
import com.example.widget.WheelRecycle;
import com.example.widget.WheelScroller;
import com.example.widget.WheelView;
import com.example.widget.WheelViewAdapter;
 ...
 */
public class WheelViewImp extends WheelView{
	 ...
	 * Constructor
	 */
	public WheelViewImp(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelViewImp(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheelViewImp(Context context) {
		super(context);
		initData(context);
	}
